 ...
 */
function detectRouterPackage(input) {
    const sources = [input.appSource ?? "", input.entrySource];
    for (const [where, src] of [["App.tsx", sources[0]], ["the entry", sources[1]]]) {
...
exports.detectRouterPackage = detectRouterPackage;
//# sourceMappingURL=router-package.js.map